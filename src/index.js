...
const produtoTemp = new Map(); // Armazena temporariamente a criação do produto por usuário
  ...
  try {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      if (commandName === 'produto') {
        ...
        if (sub === 'criar') {
          // Inicializa dados temporários do produto para este usuário
    ...
    if (interaction.isButton()) {
      // Configuração de Produtos (Modais para cada botão)
